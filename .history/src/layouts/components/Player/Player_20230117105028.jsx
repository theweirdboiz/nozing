    ...
    <section className="fixed bottom-0 left-0 right-0 px-[2rem] border border-border-primary flex items-center justify-between">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex gap-x-3 items-center">
          <span>00:00</span>
          <div className="h-1 bg-purple-primary w-full"></div>
          <span>00:00</span>
        </div>
      </div>
      {/* option */}
      <div className="w-[30%] flex items-center justify-end gap-x-5">
        <button className="circle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div className="w-[1px] h-10 border-l-2 ml-5 border-border-primary"></div>
        <button className="">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
