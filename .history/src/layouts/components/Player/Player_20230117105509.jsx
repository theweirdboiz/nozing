...
const Player = () => {
  return (
    <section className="fixed bottom-0 left-0 right-0 px-[2rem] border border-border-primary flex items-center justify-between">
      ...
      <div className="flex flex-col flex-1">
        <div className="flex gap-x-8 items-center justify-center">
          ...
          {/* play */}
          <button className="hover:text-link-text-hover">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className="flex gap-x-3 items-center text-secondary">
          <span>00:00</span>
          <div className="h-[2.5px] bg-purple-primary w-full rounded-sm"></div>
          <span>00:00</span>
        </div>
      </div>
      {/* option */}
      <div className="w-[30%] flex items-center justify-end gap-x-2">
        ...
        <div className="w-[1px] h-10 border-l-2 ml-6 border-border-primary"></div>
