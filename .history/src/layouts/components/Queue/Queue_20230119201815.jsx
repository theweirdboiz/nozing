...
const Queue = () => {
  return (
    <aside className="fixed right-0 top-0 w-[33rem] bottom-[9rem] bg-queue-player-bg shadow-box-shadow-queue flex flex-col hidden">
          ...
          <div className="absolute inset-0 scrollbar-thin px-3">
            ...
            <div className="mt-6 text-[1.4rem]">
              ...
              <p className="text-secondary font-medium">
                Từ play list{" "}
                <Link className="ml-1 text-link-text-hover capitalize">
                  Xuân lắng đọng
                </Link>
              </p>
