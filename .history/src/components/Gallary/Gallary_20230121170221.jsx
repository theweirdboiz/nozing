...
const Gallary = (props) => {
  return (
    <>
      <div class="gallary">
        <div class="gallary__container" style="height: 221.594px">
          ...
          <div class="gallary__item gallary__item--selected">
            <a href="">
              <figure class="gallary__img">
                <img
          ...
          <div class="gallary__item gallary__item--next">
            <a href="">
              <figure class="gallary__img">
                <img
          ...
          <div class="gallary__item gallary__item--last">
            <a href="">
              <figure class="gallary__img">
                <img
          ...
          <div class="gallary__item gallary__item--add">
            <a href="">
              <figure class="gallary__img">
                <img
          ...
          <div class="gallary__item gallary__item--first">
            <a href="">
              <figure class="gallary__img">
                <img
