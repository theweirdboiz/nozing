...
const LoginVipContainer = ({ container }) => {
  ...
  return (
    <div className={`${bgColor} container-login-vip`}>
      ...
      <div
        className={`inline-block uppercase font-semibold text-[12px] p-1 rounded-[99rem] py-[4px] px-[34px] cursor-pointer  ${buttonBgColor} ${buttonColor} ${
          isVip ? "border border-transparent" : "border border-current"
        }`}
      >
        {buttonText}
      </div>
