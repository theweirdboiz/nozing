...
const CardSong = (props) => {
  return (
    <div className="flex rounded-xl items-center p-3 gap-x-3 relative group/item">
      <div className="group-hover/item:bg-alpha-bg">
        <figure className="w-[4rem] h-[4rem] rounded-lg overflow-hidden relative">
          <img
            ...
            alt=""
          />
          <div className="absolute inset-0 group-hover/item:bg-opacity">
            <button className="">
              <svg
      ...
      <div className="absolute right-3  invisible group-hover/item:visible rounded-xl flex justify-between items-center p-8">
